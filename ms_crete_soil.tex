...
Soil erosion \parencite{panagos2014seasonal}


\subsection{Samplings}

WoSIS open platform hosts data regarding a wide range of soil sampling with metadata
about soil taxonomy, physical and chemical metadata. 
contains soil samplings about physical and chemical characteristics.
It contains 27 soil samples from Crete which were collected by
...
and Greece. Soil maps of Crete require more sampling effort to be completed. 
That is the reason of the coarse mapping of the Harmonized World Soil Database map of Crete, Figure \ref{fig:crete-data-cube-maps}.
...
1960 there are 1021 unique taxa with 2051 occurrences submitted by 62 publishers (Figure \ref{fig:crete-samplings}).
