...
\noindent\textsuperscript{*} Corresponding author: \texttt{kotoulas@hcmr.gr}
...
Island Sampling Day soil microbiome data \parencite{holm2025first},
...
The name of Crete is unambiguous name which reduces the false positives when performing queries in databases.
...
The data of samplings are contain sequences (fastq files), biodiversity (tab separated files)
...
Visualisation was implemented with ggplot2 \parencite{wickham_ggplot2_2016} and .
...
The collection of different data types for one place, Crete, allowed for a 
schematic representation in three axis:
data structure, temporal scale and spatial scale, represented in Figure \ref{fig:crete_idea_fig1}. 

data cubes and the species occurrences cube \parencite{oldoni2020occurrence,groom2023b-cubed:}

Living Labs \parencite{alhajj-ali2025a-review}
...
Crossref and Dimensions compare with Google Scholar, Microsoft Academic, Scopus and the Web of Science? 

\parencite{harzing2019two-new-kids}
...
Regarding the Biodiversity Heritage Library and historical literature,
