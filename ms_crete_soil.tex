...
\begin{abstract}
    ...
    Islands are important soil case studies for this integration for more resolute and dense samplings.
    ...
    Here we utilize Crete, Greece as an island model to integrate and synthesize
    open data about soil and environmental works on the island originating 
    from the literature, samplings and spatial data, i.e maps.
    We integrated data from 18 different resources; four (4) for literature, five (5) for samplings
    and nine (9) for maps data.
    We identified the sampling of the Island Sampling Day Crete 2016, a soil microbiome 16S rRNA gene
    study, as the most resolute study on the soil of Crete, with 144 samples across 72 locations. 
    Using ISD as a case study along with the Crete integrated data allowed for soil health 
    assessments about potential pathogens and microbial differences in desertification, land use change,
    and soil erosion. 
    ...
    Cretan has been studied for centuries for its diverse  and endemic
    fauna and flora.
