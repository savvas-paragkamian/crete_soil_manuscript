...
Soils are characterised by multiple properties; chemical (pH, nutrients etc.), physical (grain size, clay content etc.) and biological that 
...
as a whole which is based on heterogeneous data \parencite{van-dyne1966ecosystems}.
The data representation of ecosystems was first mentioned as "digital earth" in the late 90s \parencite{Goodchild_2012}.
...
datascapes \parencite{rolland2024datascape:}
...
\parencite{davies2023island}

Smaller scales of such integrating systems exist like
...
\subsection{Crete}
Crete has been sampled for soil and biodiversity in many different ecosystems and 
...
To address these questions, first we created a data repository categorised in 
literature (text), samplings (point data) and spatial data (maps). 
Using these data as a foundation, we summarised each resource contents and
identified gaps and opportunities for subsequent analyses.
The Island Sampling Day soil microbiome data \parencite{holm2025first} stand out as a large scale island-wide
microbiome study to support our investigations on the differences of the
microbiome communities across land use, aridity and functional categories.
...
a Cretan soil biodiversity data system, Figure \ref{fig:crete_idea_fig1}. First, the literature regarding 
...
terrestrial environmental layers indicate in Supplementary Figure 2.
...
The Island Sampling Day (ISD) project \parencite{holm2025first}
was organised by of the Genome Standards Consortium \parencite{Field2011} and the Hellenic Centre for Marine Research
...
The ISD is most comprehensive soil microbiome study in the confined space of the island of Crete \ref{fig:crete-samplings} .
...
and Greece in general. These maps are not as complete as the geological maps (Supplementary Figure 2 C), 
and that is the reason of the coarse mapping of the Harmonized World Soil Database map of Crete (Supplementary Figure 2 D).
