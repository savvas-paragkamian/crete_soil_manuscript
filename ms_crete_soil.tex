...
There are global resources and platforms databases like European Nucleotide Archive (ENA) \parencite{ocathail2024the-european},
...
Open data soil data are hosted by the 
...
To tackle the challenge of digital representation there have been established model systems
and scientific stations such
as the Mo'orea Gump Station \parencite{Davies2016} and the Middle east natural laboratory \parencite{blanco-sacristan2024the-middle}.
In the global and continental scale multiple studies have explored and discovered the remarkable diversity in soils yet there are blind spots \parencite{Guerra2020}.
